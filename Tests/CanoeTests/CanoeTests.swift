...
final class TableViewHelperTests: XCTestCase {
    ...
    func testInsertSectionAtIndex() {
        // Given
        tableViewHelper.show(sections: makeSections(count: 10, rowsCount: 1))
        ...
        XCTAssertEqual(tableViewHelper.sections.count, 11)
    }
    ...
    func testRemoveSectionAtIndex() {
        ...
        // Then
        XCTAssertEqual(tableViewHelper.sections.count, 9)
        XCTAssertEqual(tableViewHelper.sections[4].id, sections[4].id)
        XCTAssertEqual(tableViewHelper.sections[5].id, sections[6].id)
        XCTAssertEqual(tableViewHelper.sections[8].id, sections[9].id)
    }

    func testRemoveSectionsInIndexSet() {
        // Given
        let sections = makeSections(count: 10, rowsCount: 1)
        tableViewHelper.show(sections: sections)
        let indexSet = IndexSet([0, 1, 5, 8, 9])

        // When
        tableViewHelper.removeSections(in: indexSet)

        // Then
        XCTAssertEqual(tableViewHelper.sections.count, 5)
        XCTAssertEqual(tableViewHelper.sections[0].id, sections[2].id)
        XCTAssertEqual(tableViewHelper.sections[1].id, sections[3].id)
        XCTAssertEqual(tableViewHelper.sections[2].id, sections[4].id)
        XCTAssertEqual(tableViewHelper.sections[3].id, sections[6].id)
        XCTAssertEqual(tableViewHelper.sections[4].id, sections[7].id)
    }
    
    func testRemoveSectionsWhere() {
        // Given
        let sections = makeSections(count: 10, rowsCount: 10)
        let testIndexes = [0, 1, 5, 6, 8, 9]
        let previousSections = testIndexes.map({ sections[$0] })
        tableViewHelper.show(sections: sections)
        ...
        // Results [C, D, E, H]
        XCTAssertEqual(tableViewHelper.sections.count, 4)
        XCTAssertEqual(tableViewHelper.sections[0].id, sections[2].id)
        XCTAssertEqual(tableViewHelper.sections[1].id, sections[3].id)
        XCTAssertEqual(tableViewHelper.sections[2].id, sections[4].id)
        XCTAssertEqual(tableViewHelper.sections[3].id, sections[7].id)
    }
    ...
    func testInsertRowAtIndexPath() {
        // Given
        let sections = makeSections(count: 1, rowsCount: 10)
        tableViewHelper.show(sections: sections)
    ...
    func testInsertRowsWhere() {
        ...
        // Then
        XCTAssertEqual(tableViewHelper.sections.count, 1)
        XCTAssertEqual(tableViewHelper.sections[0].rows.count, 10 + newRows.count)
        ...
        XCTAssertEqual(tableViewHelper.sections[0].rows[7].id, section.rows[3].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[8].id, section.rows[4].id)
        
        // We added 4 before that. 5 + 4 = 9
        XCTAssertEqual(tableViewHelper.sections[0].rows[9].id, newRows[4].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[10].id, section.rows[5].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[11].id, newRows[5].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[12].id, newRows[6].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[13].id, section.rows[6].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[14].id, newRows[7].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[15].id, section.rows[7].id)

        // We added 8 before that. 8 + 8 = 16
        XCTAssertEqual(tableViewHelper.sections[0].rows[16].id, newRows[8].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[17].id, section.rows[8].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[18].id, newRows[9].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[19].id, newRows[10].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[20].id, section.rows[9].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[21].id, newRows[11].id)
    }
    ...
    func testRemoveRowAtIndexPath() {
        ...
        // Then
        XCTAssertEqual(tableViewHelper.sections.count, 1)
        XCTAssertEqual(tableViewHelper.sections[0].rows.count, 9)
        ...
        XCTAssertEqual(tableViewHelper.sections[0].rows[8].id, section.rows[9].id)
    }
    ...
    func testRemoveRowsWhere() {
        ...
        // Then
        XCTAssertEqual(tableViewHelper.sections.count, 1)
        XCTAssertEqual(tableViewHelper.sections[0].rows.count, 4)
        ...
        XCTAssertEqual(tableViewHelper.sections[0].rows[2].id, section.rows[4].id)
        XCTAssertEqual(tableViewHelper.sections[0].rows[3].id, section.rows[7].id)
    }
